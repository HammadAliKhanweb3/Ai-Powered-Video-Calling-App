...
import { CallSessionEndedEvent, CallSessionParticipantLeftEvent, CallSessionStartedEvent, CallTranscriptionReadyEvent, CallRecordingReadyEvent, MessageNewEvent } 
...
export async function POST(req:NextRequest){
    ...
    if(!verifyVideoSignatureSdk(body,signature)){
