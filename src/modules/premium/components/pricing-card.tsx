...
const pricingCardSecondryTextVariants = cva("text-neutral-700",{
variants:{
    variant:{
...
export const PricingCard = ({
   ...
   return(
    ...
    <div className="flex items-end gap-x-4 justify-between mb-8">
        ...
        <p 
         className={cn(
            "text-xs",
            pricingCardSecondryTextVariants
         )}
         >
           {description} 
         </p>
        ...
        <div className="flex items-end shrink-0 gap-x-0.5">
         ...
         <span className={cn(pricingCardSecondryTextVariants({variant}))}>
            {priceSuffix}
         </span>
        </div>
    </div>
    ...
    <div className="flex flex-col gap-y-2 mt-6">
        <p className="font-medium uppercase>Features">Features</p>
       <ul
        className={cn(
            "text-xs",
            pricingCardSecondryTextVariants({variant})
         )}
       >
