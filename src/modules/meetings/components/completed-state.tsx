...
import { BookOpenTextIcon, ClockFadingIcon, FileTextIcon, FileVideoIcon, Sparkles, SparklesIcon, WandSparklesIcon } from "lucide-react"
...
export const CompletedState = ({data}:Props)=>{
    ...
    <TabsContent value="recording">
        <div className="bg-white rouded-lg border px-4 py-5">
          <video 
         ...
         {data.duration ? formatDuration(data.duration) : "No duration"}
          ...
          <Markdown
           components={{
            ...
            ul:(props)=>(<ul className="list-decimal list-inside mb-6" {...props}/>
            ),
